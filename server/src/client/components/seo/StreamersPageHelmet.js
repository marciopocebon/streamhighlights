...
render() {
    return (
        ...
        <meta property="description" content="Streams Highlights gathers the best clips and highlights from Twitch. We provide unique clips for League of Legends, Fortnite, Counter-Strike and many more." />
    </Helmet>
    );
  }
}
