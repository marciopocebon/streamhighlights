...
render() {
    ...
    return (
     <Helmet>
        ...
        <meta name="description" content={`Streams Highlights gathers the best clips and highlights from Twitch. Find the best clips and highlights for ${streamer} now!`} />
    </Helmet>
    );
  }
}
