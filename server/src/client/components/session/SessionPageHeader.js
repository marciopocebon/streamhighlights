...
import SessionPageHelmet from '../seo/SessionPageHelmet'
...
class SessionPageHeader extends Component {
  render() {
    ...
    return (
      <div>
        {archives && archives.items[0] && archives.items[0].archive && <SessionPageHelmet archive={archives.items[0].archive.title}/>}
